...
List<int> GetScores()
{
    ...
    while ((line = Console.ReadLine()) != null)
    {
        ...
        (int score, string choice) = ScoreForRound(input);
        scores.Add(score + ScoreForChoice(choice));
    }
...
static (int Score, string Choice) ScoreForRound(string[] input) => input[0] switch
{
    "A" => input[1] switch
    {
        "X" => (0, "Z"),
